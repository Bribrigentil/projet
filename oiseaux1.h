...
public:
  ...
  //  oiseau(double R, double R1, double vgroupe,  double Taillesurfacex, double Taillesurfacey);
  oiseau(double R, double R1, double vgroupe,  double Taillesurfacex, double Taillesurfacey, vector<cercle> obst);
  ...
  void comportement(double R, double R1);
