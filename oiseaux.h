...
public:
  ...
  oiseau(double R, double T, double A, double M, double vgroupe,  double Taillesurfacex, double Taillesurfacey,double TailleOiseau);
  ...
  void comportement(double R, double T, double A, double M,double TailleOiseau);
